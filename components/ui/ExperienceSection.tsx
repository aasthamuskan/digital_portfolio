                        ...
                        >
                            ...
                            <div className="flex flex-col md:flex-row gap-6 md:gap-10">
                                ...
                                <div className="md:w-2/3 border-t md:border-t-0 md:border-l border-white/10 pt-6 md:pt-0 md:pl-10">
                                    ...
                                    {(expr as any).certificateLink && (
                                        <button 
                                            onClick={() => setSelectedCert({ name: "Internship Certificate", link: (expr as any).certificateLink })}
                                            className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20 rounded-lg text-sm font-medium transition-colors w-fit cursor-pointer mt-4"
                                        >
                                            View Certificate
                                            <Eye size={16} />
                                        </button>
